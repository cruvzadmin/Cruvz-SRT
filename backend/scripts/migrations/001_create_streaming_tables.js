 ...
 * PostgreSQL only - optimized for enterprise-grade performance
 */
...
exports.up = function(knex) {
  return knex.schema
    ...
    .createTable('streams', (table) => {
      ...
      table.text('settings'); // JSON field for PostgreSQL optimization
    ...
    .createTable('stream_sessions', (table) => {
      ...
      table.text('quality_metrics'); // JSON field for PostgreSQL optimization
    ...
    .createTable('stream_analytics', (table) => {
      ...
      table.text('geographic_data'); // JSON field for PostgreSQL optimization
      table.text('device_data'); // JSON field for PostgreSQL optimization
      table.text('quality_metrics'); // JSON field for PostgreSQL optimization
      table.timestamps(true, true);
    ...
    .createTable('notifications', (table) => {
      ...
      table.string('title', 200).notNullable();
      table.text('message');
      table.text('metadata'); // JSON field for PostgreSQL optimization
    ...
    .createTable('system_health', (table) => {
      ...
      table.text('alerts'); // JSON field for PostgreSQL optimization
